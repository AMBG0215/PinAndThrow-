...
var DETAIL_DEFAULT_CENTER = [14.5547, 121.0244];
...
function updateDetailMap(latValue, lngValue) {
  ...
  var lat = parseCoord(latValue);
  var lng = parseCoord(lngValue);
  var coordsEl = document.getElementById('detailCoords');
...
function initDetailMap() {
  ...
  var selectedRow = document.querySelector('.report-row.selected') || document.querySelector('.report-row');
  if (selectedRow) {
